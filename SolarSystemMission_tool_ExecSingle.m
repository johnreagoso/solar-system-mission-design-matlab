...
function [PosVectorDepart, VelVectorDepart, PosVectorAtArrival, sc_Heliocen_postFlyby] = SolarSystemMission_tool_ExecSingle(...
    PlanetDepart, PlanetArrival1, PlanetArrival2, JulianDayDep, JulianDayArrival1, JulianDayArrival2)
...
John Reagoso        02/20/2024          Created.
 ...
 %}
    ...
    [GregArrival2Date, ~, ~, ~] = JulianDay_to_Greg_cal(JulianDayArrival2);
